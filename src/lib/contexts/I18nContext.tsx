...
export const englishTranslations = {
  ...
  'passwordChange.title': 'Set a new password',
  'passwordChange.subtitle': 'Your password must be changed before you can continue.',
  'passwordChange.current': 'Current password',
  'passwordChange.new': 'New password',
  'passwordChange.confirm': 'Confirm new password',
  'passwordChange.submit': 'Update password',
  'passwordChange.submitting': 'Updating...',
  'passwordChange.mismatch': 'New passwords do not match',
  'passwordChange.tooShort': 'New password must be at least 8 characters',
  'passwordChange.failed': 'Could not change password',
...
export const dutchTranslations: Record<SmoothGuiTranslationKey, string> = {
  ...
  'passwordChange.title': 'Stel een nieuw wachtwoord in',
  'passwordChange.subtitle': 'Uw wachtwoord moet worden gewijzigd voordat u verder kunt.',
  'passwordChange.current': 'Huidig wachtwoord',
  'passwordChange.new': 'Nieuw wachtwoord',
  'passwordChange.confirm': 'Bevestig nieuw wachtwoord',
  'passwordChange.submit': 'Wachtwoord bijwerken',
  'passwordChange.submitting': 'Bijwerken...',
  'passwordChange.mismatch': 'Nieuwe wachtwoorden komen niet overeen',
  'passwordChange.tooShort': 'Nieuw wachtwoord moet minimaal 8 tekens bevatten',
  'passwordChange.failed': 'Kan wachtwoord niet wijzigen',
